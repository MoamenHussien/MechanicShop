    ...
    private async Task TrySeedDataAsync()
    {
        ...
        if (!await context.RepairTasks.AnyAsync())
        {
            await context.RepairTasks.AddRangeAsync([
                RepairTask.Create(Guid.Parse("ffffffff-ffff-ffff-ffff-000000000001"), "Engine Oil Change", 50.00m, RepairDurationInMinute.Min60, [Part.Create(Guid.Parse("ffffffff-ffff-ffff-ffff-100000000001"), 25.00m, "Engine Oil", 1).Value, Part.Create(Guid.Parse("ffffffff-ffff-ffff-ffff-100000000002"), 10.00m, "Oil Filter", 1).Value]).Value,
                RepairTask.Create(Guid.Parse("ffffffff-ffff-ffff-ffff-000000000002"), "Brake Replacement", 150.00m, RepairDurationInMinute.Min90, [Part.Create(Guid.Parse("ffffffff-ffff-ffff-ffff-200000000001"), 40.00m, "Brake Pads", 2).Value, Part.Create(Guid.Parse("ffffffff-ffff-ffff-ffff-200000000002"), 15.00m, "Brake Fluid", 1).Value]).Value,
                RepairTask.Create(Guid.Parse("ffffffff-ffff-ffff-ffff-000000000003"), "Tire Rotation", 30.00m, RepairDurationInMinute.Min45, [Part.Create(Guid.Parse("ffffffff-ffff-ffff-ffff-300000000001"), 5.00m, "Tire Valve", 4).Value]).Value,
                RepairTask.Create(Guid.Parse("ffffffff-ffff-ffff-ffff-000000000004"), "Battery Replacement", 70.00m, RepairDurationInMinute.Min30, [Part.Create(Guid.Parse("ffffffff-ffff-ffff-ffff-400000000001"), 120.00m, "Car Battery", 1).Value]).Value,
                RepairTask.Create(Guid.Parse("ffffffff-ffff-ffff-ffff-000000000005"), "Wheel Alignment", 80.00m, RepairDurationInMinute.Min60, [Part.Create(Guid.Parse("ffffffff-ffff-ffff-ffff-500000000001"), 5.00m, "Alignment Shim Kit", 4).Value]).Value,
                RepairTask.Create(Guid.Parse("ffffffff-ffff-ffff-ffff-000000000006"), "Air Conditioning Recharge", 100.00m, RepairDurationInMinute.Min30, [Part.Create(Guid.Parse("ffffffff-ffff-ffff-ffff-600000000001"), 50.00m, "Refrigerant", 1).Value]).Value,
                RepairTask.Create(Guid.Parse("ffffffff-ffff-ffff-ffff-000000000007"), "Spark Plug Replacement", 90.00m, RepairDurationInMinute.Min60, [Part.Create(Guid.Parse("ffffffff-ffff-ffff-ffff-700000000001"), 10.00m, "Spark Plug", 4).Value]).Value,
                RepairTask.Create(Guid.Parse("ffffffff-ffff-ffff-ffff-000000000008"), "Engine Diagnostic", 120.00m, RepairDurationInMinute.Min120, [Part.Create(Guid.Parse("ffffffff-ffff-ffff-ffff-800000000001"), 20.00m, "Smoke Leak Detector Fluid Cartridge", 1).Value]).Value,
                RepairTask.Create(Guid.Parse("ffffffff-ffff-ffff-ffff-000000000009"), "Timing Belt Replacement", 200.00m, RepairDurationInMinute.Min120, [Part.Create(Guid.Parse("ffffffff-ffff-ffff-ffff-900000000001"), 75.00m, "Timing Belt", 1).Value]).Value,
                RepairTask.Create(Guid.Parse("ffffffff-ffff-ffff-ffff-000000000010"), "Transmission Fluid Change", 100.00m, RepairDurationInMinute.Min45, [Part.Create(Guid.Parse("ffffffff-ffff-ffff-ffff-a00000000001"), 60.00m, "Transmission Fluid", 1).Value]).Value
            ]);
        }
