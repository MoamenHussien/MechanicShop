        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Token = table.Column<string>(type: "nvarchar(125)", maxLength: 125, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Costs = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Invoice Line Item", x => new { x.InvoiceId, x.LineNumber });
                    table.ForeignKey(
                        name: "FK_Invoice Line Item_Invoices_InvoiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleMakes_Make",
                table: "VehicleMakes",
                column: "Make",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VehicleModels_VehicleMakeId_Model",
                table: "VehicleModels",
                columns: new[] { "VehicleMakeId", "Model" },
                unique: true);
