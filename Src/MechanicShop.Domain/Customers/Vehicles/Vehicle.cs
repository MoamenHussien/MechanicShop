...
#pragma warning restore CS8618
    ...
    private Vehicle(Guid id , int Year , string LicensePlate,Guid VehicleModelId ) : base (id)
    {
        this.Year = Year;
    ...
    public static Result<Vehicle> Created(Guid id ,int Year,string LicensePlate,Guid VehicleModelId)
    {
        if (id == Guid.Empty)
        {
            id = Guid.NewGuid();
